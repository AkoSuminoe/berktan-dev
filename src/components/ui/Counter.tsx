import { type MotionValue, motion, useSpring, useTransform, useReducedMotion } from 'framer-motion';
...
function Digit({ place, value, height, digitStyle }: DigitProps) {
  ...
  // Numeric digit
  // Support negative values by animating the absolute magnitude
  ...
  }, [animatedValue, valueRoundedToPlace, reduce]);
